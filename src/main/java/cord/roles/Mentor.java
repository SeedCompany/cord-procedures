...
public class Mentor extends BaseRole {
  public Mentor(){
    super(RoleNames.MentorRole, Mentor.permission);
  }

  public static IPermission permission = (BaseNodeLabels label, String property) -> {
    switch(label){
      case Budget:                return Mentor.Budget(                 Budget.valueOf(property));
      case BudgetRecord:          return Mentor.BudgetRecord(           BudgetRecord.valueOf(property));
      case Ceremony:              return Mentor.Ceremony(               Ceremony.valueOf(property));
      case Directory:             return Mentor.Directory(              Directory.valueOf(property));
      case Education:             return Mentor.Education(              Education.valueOf(property));
      case EthnologueLanguage:    return Mentor.EthnologueLanguage(     EthnologueLanguage.valueOf(property));
      case FieldRegion:           return Mentor.FieldRegion(            FieldRegion.valueOf(property));
      case FieldZone:             return Mentor.FieldZone(              FieldZone.valueOf(property));
      case File:                  return Mentor.File(                   File.valueOf(property));
      case FileVersion:           return Mentor.FileVersion(            FileVersion.valueOf(property));
      case Film:                  return Mentor.Film(                   Film.valueOf(property));
      case FundingAccount:        return Mentor.FundingAccount(         FundingAccount.valueOf(property));
      case InternshipEngagement:  return Mentor.InternshipEngagement(   InternshipEngagement.valueOf(property));
      case Language:              return Mentor.Language(               Language.valueOf(property));
      case LanguageEngagement:    return Mentor.LanguageEngagement(     LanguageEngagement.valueOf(property));
      case LiteracyMaterial:      return Mentor.LiteracyMaterial(       LiteracyMaterial.valueOf(property));
      case Location:              return Mentor.Location(               Location.valueOf(property));
      case Organization:          return Mentor.Organization(           Organization.valueOf(property));
      case Partner:               return Mentor.Partner(                Partner.valueOf(property));
      case Partnership:           return Mentor.Partnership(            Partnership.valueOf(property));
      case Project:               return Mentor.Project(                Project.valueOf(property));
      case ProjectMember:         return Mentor.ProjectMember(          ProjectMember.valueOf(property));
      case Product:               return Mentor.Product(                Product.valueOf(property));
      case Song:                  return Mentor.Song(                   Song.valueOf(property));
      case Story:                 return Mentor.Story(                  Story.valueOf(property));
      case Unavailability:        return Mentor.Unavailability(         Unavailability.valueOf(property));
      case User:                  return Mentor.User(                   User.valueOf(property));
